...
#         root:File = crud.create_directory(db=self.db, owner_id=owner_id,name=owner_id, parent_id=None)
#         sub:File = crud.create_directory(db=self.db, owner_id=owner_id,name=dt_obj.year, parent_id=root.id)
#         sub:File = crud.create_directory(db=self.db, owner_id=owner_id,name=dt_obj.month, parent_id=sub.id)
#         sub:File = crud.create_directory(db=self.db, owner_id=owner_id,name=dt_obj.day, parent_id=sub.id)
